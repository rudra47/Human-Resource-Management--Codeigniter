        	    ...
        	    <div class="col-md-8">
                  ...
                  ?>
	        	    ...
	        	    <div class="col-md-3 col-md-offset-9">
	        	    	<a href="<?php echo site_url('admin/attendance_single/'.$row->employee_name.'/'.$row->emp_user_id); ?>"><button class="btn btn-primary pull-right" >View Full Month Data</button></a>
	        	    </div>
