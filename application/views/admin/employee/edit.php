      ...
      <div class="">
        ...
        <!-- Cutting -->
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo base_url()."admin/update_employee/".$row->employee_id; ?>" method="post">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" placeholder="Enter Employee Name" name="employee_name" value="<?php echo $row->employee_name ?>">
                  <span class="text-danger"><?php echo form_error('employee_name'); ?></span>
                </div>

                <div class="form-group">
                  <label for="phone">Phone</label>
                  <input type="text" class="form-control" id="phone" placeholder="Enter Employee Phone Number" name="employee_phone" value="<?php echo $row->employee_phone ?>">
                  <span class="text-danger"><?php echo form_error('employee_phone'); ?></span>
                </div>

                <div class="form-group">
                  <label for="email">Email</label>
                  <input type="email" class="form-control" id="email" placeholder="Enter Employee Email Address" name="employee_email" value="<?php echo $row->employee_email; ?>">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="employee_designation">
                    ...
                    <option value="<?php echo $designation->designation_id; ?>" <?php if($row->employee_designation == $designation->designation_id) echo "selected"; ?>><?php echo $designation->designation_name; ?></option>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="salary" placeholder="Enter Employee salary" name="employee_salary" value="<?php echo $row->employee_salary; ?>">
