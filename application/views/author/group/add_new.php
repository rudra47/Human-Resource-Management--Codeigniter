	...
	<div id="con_main">
		...
		<?php 												
		 	echo form_open('author/group/add','class="form-horizontal"'); 				 
		 ?>		
          ...
          <fieldset>
            ...
            <div class="form-group" >
                ...
                <div class='col-sm-6'>
				<?php echo form_input('grp_title', set_value('grp_title'),'class="form-control"'); ?>
                </div>
            </div>
            ...
            <div class="form-group" >
	            ...
	            <div class='col-sm-6'>                
				<?php echo form_dropdown('grp_parent', $grp, 'active','class="form-control"');?>
