	 ...
	 <div id="con_1">
		<span class="breadcrumbs"> <i class="fa fa-plus-square"></i> Group Manager &rarr; Group Deletion</span>
	 	<span class="logout"> 
			<a href="<?php echo base_url(); ?>index.php/author/group" class="btn btn-danger"> -Cancle</a>
		</span>	
	 </div>
