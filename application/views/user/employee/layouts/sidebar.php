  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      ...
      <div class="pull-left info">
        <p><?php echo $this->session->employee_name; ?></p>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="<?php echo site_url('employee/confirmation_leave/'.$this->session->employee_id.'/'); ?>"><i class="fa fa-circle-o"></i> Confirmation </a></li>
          <li><a href="<?php echo site_url('employee/accepted_leave/'.$this->session->employee_id.'/'); ?>"><i class="fa fa-circle-o"></i> Accepted </a></li>
          <li><a href="<?php echo site_url('employee/rejected_leave/'.$this->session->employee_id.'/'); ?>"><i class="fa fa-circle-o"></i> Rejected </a></li>
          <li><a href="<?php echo site_url('employee/pending_leave/'.$this->session->employee_id.'/'); ?>"><i class="fa fa-circle-o"></i> Pending </a></li>
          
        </ul>
      </li>

      <li>
        <a href="<?php echo site_url('employee/all_task/') ?>">
          <i class="fa fa-tasks"></i>
          <span>My Task</span>
        </a>
      </li>
