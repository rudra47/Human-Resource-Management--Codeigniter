          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                  foreach ($confirmation_leave->result() as $row): ?>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo site_url('employee/view_application/'.$row->app_id); ?>"><button class="btn btn-success">Confirmation</button></a></td>
                  </tr>
