      ...
      <div class="">
        ...
        <!-- Cutting -->
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo base_url()."employee/attendance_store"; ?>" method="post">
              
              <div class="box-body">
                <div class="form-group">
                  <label for="name">Sign Out</label>
              ...
              <div class="box-footer">
                <input type="submit" class="btn btn-primary" name="part_time_signout" value="Submit" name="start_time">
