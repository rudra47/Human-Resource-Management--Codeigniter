      ...
      <div class="">
        ...
        <!-- Cutting -->
          ...
          <div class="box box-primary">
            ...
            <form action="<?php echo base_url()."employee/attendance_store"; ?>" method="post">
              ...
              <div class="box-footer">
                <input type="submit" class="btn btn-primary" name="start_time" value="Submit" name="start_time">
