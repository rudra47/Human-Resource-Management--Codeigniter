      ...
      <div class="col-md-6 offset-md-3 border border-primary" style=" margin-top: 40px;">
        ...
        <form action="<?php echo base_url()."main/store";?>" method="post">
          <fieldset style="padding: 20px;">
            ...
            <div class="form-group">
              <label for="emp_username"><b>Office Starting Time</b></label> 
            ...
            <input type="submit" name="start_time" value="submit" class="btn btn-primary">
            <!-- <button type="submit" name="start_time" class="btn btn-primary">Submit</button> -->
          </fieldset>
        </form>
